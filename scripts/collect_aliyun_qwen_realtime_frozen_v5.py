...
def collect(args: argparse.Namespace) -> Dict[str, Any]:
            ...
            diagnostic_rows.append(
                {
                    ...
                    "unmapped_rate": metrics["unmapped_rate"],
            ...
            decisions.append(
                {
                    ...
                    "example_acceptance_gate_passed": passes,
                }
            )
    ...
    result = {
        ...
        "example_acceptance_gate": decisions,
        "notes": [
            "s5/s10 are the example gate conditions; s1/s3 are additional low-support checks.",
            ...
            "The example gate is a utility threshold and is not a manuscript acceptance or result claim.",
        ],
    }
